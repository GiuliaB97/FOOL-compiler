...
///////////////////////////////////////////////////////////////////////////OTTIMIZZAZIONE 
	...
	public TypeNode visitNode(EqualNode n) throws TypeException {
		...
		if (l instanceof ArrowTypeNode || r instanceof ArrowTypeNode) //MOD HO: non consente l'uso di espressioni con i tipi funzionali
...
////////////////////////////////////////////////////LANGUAGE EXTENSION NODES
	...
	@Override
	public TypeNode visitNode(AndNode n) throws TypeException {//uguale a quelli delle operazioni ma, sui bool
		if (print) printNode(n);
